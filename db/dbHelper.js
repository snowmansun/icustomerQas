...
var conString = 'Server=tcp:ga98eyp2ih.database.chinacloudapi.cn,1433;Database=eBestStaging_Qas;User ID=ebestmobile;Password=Sharepoint@admin;Trusted_Connection=False;Encrypt=True;Connection Timeout=30000;';
//执行sql,返回数据.  
